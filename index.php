...
<html class="loading">
  ...
  <body class="vertical-layout" style="background-color:#031e1d;">
    <div class="app-content content" style="background-color:#031e1d;">
      <div class="content-wrapper" style="background-color:#031e1d;">
        <div class="content-wrapper-before mb-3" style="background-color:#031e1d;">     	
        </div>        
  <div class="content-body"style="background-color:#031e1d;">
  	<div class="mt-2"></div>
	<div class="row"style="background-color:#031e1d;">
		<div class="col-md-8"style="background-color:#031e1d;">
			<div class="card"style="background-color:#031e1d;">
				<div class="card-body text-center"style="background-color:#031e1d;">
					<h4 class="mb-2"style="color:goldenrod;">JUNED NYEKER</h4>
					<textarea rows="12" class="form-control text-center form-checker mb-2"style="background-color:#031e1d;" placeholder="░T░H░R░O░W░ ░G░E░N░ ░C░A░R░D░ ░H░E░R░E░"></textarea>
					</br>

					          <select name="gate"style="background-color:gainsboro;" id="gate" class="form-control" style="margin-bottom: 5px;"

    <option </option>
	            

        <option style="background-color:#031e1d;" value="gate/api1.php">API 1 - KOSONG</option>
        
        <option style="background-color:#031e1d;" value="gate/api2.php">API 2 - KOSONG</option>  

        <option style="background-color:#031e1d;" value="gate/api3.php">API 3 - KOSONG</option> 

        <option style="background-color:#031e1d;" value="gate/api.php">API 4 - $45</option>  

        <option style="background-color:#031e1d;" value="gate/api5.php">API 5 - KOSONG</option>

        <option style="background-color:#031e1d;" value="gate/api6.php">API 6 - KOSONG</option>

        <option style="background-color:#031e1d;" value="gate/api7.php">API 7 - KOSONG</option>

        <option style="background-color:#031e1d;" value="gate/api8.php">API 8 - KOSONG</option>

        <option style="background-color:#031e1d;" value="gate/api9.php">API 9 - KOSONG</option>
...
<div class="col-md-4"style="background-color:#031e1d;">
  <div class="card mb-2"style="background-color:#031e1d;">
  	<div class="card-body"style="background-color:#031e1d;">
<left>
...
<left>
			...
			<div class="card"style="background-color:#031e1d;">
				<div class="card-body"style="background-color:#031e1d;">
					<div class="float-right"style="background-color:#031e1d;">
...
<footer>
  <p> <b><div class="text"style="color:goldenrod;">E̷D̷I̷T̷ ̷B̷Y̷ ̷: BARUDAK JAWIRS
</footer>
<style>
