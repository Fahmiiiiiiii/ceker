...
curl_setopt($ch, CURLOPT_POSTFIELDS, 'amount='.$chr.'&currency=usd&payment_method_types[]=card&description=Balad Juned&payment_method='.$tok1.'&confirm=true&off_session=true');  
